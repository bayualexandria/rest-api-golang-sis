...
func GetUsersByNIP(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusNotFound, gin.H{"message": "User tidak ditemukan atau NIP salah", "status": 404})
		return
	}
